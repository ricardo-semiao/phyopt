...
[![Codecov test coverage](https://codecov.io/gh/ricardo-semiao/phyopt/graph/badge.svg)](https://app.codecov.io/gh/ricardo-semiao/phyopt)
<!-- badges: end -->

This package implements a two-step, population-based, hybrid optimization algorithm, for solving problems of the form:
...
The paper fully describing the motivation, theoretical framework, and method design is available at `vignette("theoretical_framework", package = "phyopt")`. The goal of the package is to provide a flexible framework for users to implement their own optimization strategies, by combining different types of _initializers_, _optimizers_, and _updaters_.
...
**Disclaimer:** this package is in an early stage of development. It hasn't been thoroughly tested and may contain several bugs. I don't recommend using it for large-scale projects yet.
...
This package is young and places much of the optimization responsibility on the user. That said, I believe it is reasonably solid. Once I implement tests and run more examples, I expect it will be stable.

Some of the more important features I plan to add in the future are:

- The `testthat` package structure is created for the package, but I haven't had the time to write unit tests yet.
